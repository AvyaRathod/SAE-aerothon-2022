...
source_folder = "batch 1"
json_path = "via_project_16Nov2022_16h59m_json.json"                      # Relative to root directory
count = 0                                           # Count of total images saved
file_bbs = {}                                       # Dictionary containing polygon coordinates for mask
MASK_WIDTH = 1200				    # Dimensions should match those of ground truth image
MASK_HEIGHT = 1600						
